...
from PyQt5.QtWidgets import (
    ...
    QPushButton,
    QLabel,
    QFileDialog, QGroupBox, QHBoxLayout, QVBoxLayout, QToolTip, QComboBox, QDialog, QProgressBar
)
...
class AudioResolutionApp(QWidget):
    ...
    def init_ui(self):
        ...
        # self.help_btn.setIcon(QIcon('Icon05.png'))
        ...
        for i in range(1, numdevices):
            if (p.get_device_info_by_host_api_device_index(0, i).get('maxInputChannels')) > 0:
                self.cb.addItem(p.get_device_info_by_host_api_device_index(0, i).get('name'))
